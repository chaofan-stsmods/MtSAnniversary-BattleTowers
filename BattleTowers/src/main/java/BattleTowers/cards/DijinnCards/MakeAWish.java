...
@AutoAdd.Ignore
public class MakeAWish extends CustomCard {
    public static final String ID = makeID(MakeAWish.class.getSimpleName());
    ...
    public MakeAWish(Dijinn dijinn, int magicNumber) {
